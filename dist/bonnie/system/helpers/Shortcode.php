 ...
 *
 * <code>
 *     Shortcode::get('default')->register('shortcode_tag_name', 'callback');
 * </code>
 *
 ...
 * *  The Shortcode instance used to parse the content.
...
class Shortcode {
    ...
    /**
     * Get the {@link Shortcode} instance that is attached to a particular identifier.
     *
    ...
    public static function get($identifier = 'default') {
        if(!array_key_exists($identifier, self::$instances)) {
            self::$instances[$identifier] = new Shortcode();
        }
    ...
    /**
     * Get the currently active/default {@link Shortcode} instance.
     *
     * @return Shortcode
     */
    ...
    /**
     * Set the identifier to use for the current active/default {@link Shortcode} instance.
     *
     ...
     *   - The {@link Shortcode} instance used to parse the content.
     *   - The shortcode tag name that was matched within the parsed content.
     *
