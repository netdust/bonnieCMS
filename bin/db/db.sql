...
--
-- Tabelstructuur voor tabel `cms_config`
--

CREATE TABLE IF NOT EXISTS `cms_config` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `key` varchar(140) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Gegevens worden geëxporteerd voor tabel `cms_config`
--

INSERT INTO `cms_config` (`id`, `key`, `value`) VALUES
(1, 'i18n.default', 'fr'),
(2, 'i18n.languages', 'fr,nl'),
(3, 'sitename', ''),
(4, 'description', ''),
(5, 'theme', 'default'),
(6, 'id', '1'),
(7, 'homepage', '1'),
(9, 'social', '{"label":"social","namespace":"data\\\\plugins\\\\social","installed":"1","id":"","title":"","share":"","image":"","description":"Adds Facebook graph data to each html-page","path":"plugins\\/social"}'),
(10, 'analytics', '{"label":"analytics","namespace":"data\\\\plugins\\\\analytics","installed":"1","id":"","description":"Adds analytics each html-page","path":"plugins\\/analytics"}'),
(11, 'canonical', '{"label":"canonical","namespace":"data\\\\plugins\\\\canonical","installed":"1","path":"plugins\\/canonical","description":"Adds canonical url to each page based on language and page slug"}');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `cms_language`
--
